            ...
            {
                {
                    "th", new System.Collections.Generic.Dictionary<string, string>
                    {
                        ...
                        {"btn_reset_path", "à¸£à¸µà¹€à¸‹à¹‡à¸• Path"},
                        {"err_invalid_dir_reset", "à¹„à¸¡à¹ˆà¸žà¸š MonsterHunterWorld.exe à¸«à¸£à¸·à¸­à¹‚à¸Ÿà¸¥à¹€à¸”à¸­à¸£à¹Œà¹€à¸à¸¡à¹„à¸¡à¹ˆà¸–à¸¹à¸à¸•à¹‰à¸­à¸‡ Path à¸–à¸¹à¸à¸£à¸µà¹€à¸‹à¹‡à¸•à¹à¸¥à¹‰à¸§ à¸à¸£à¸¸à¸“à¸²à¹€à¸¥à¸·à¸­à¸à¹‚à¸Ÿà¸¥à¹€à¸”à¸­à¸£à¹Œà¹€à¸à¸¡à¹ƒà¸«à¸¡à¹ˆ"},
                        {"title_path_error", "à¸‚à¹‰à¸­à¸œà¸´à¸”à¸žà¸¥à¸²à¸” Game Path"},
                        {"auto_enable", "à¸•à¸´à¸”à¸•à¸±à¹‰à¸‡à¸¡à¹‡à¸­à¸”à¹€à¸‚à¹‰à¸²à¹€à¸„à¸£à¸·à¹ˆà¸­à¸‡à¸­à¸±à¸•à¹‚à¸™à¸¡à¸±à¸•à¸´à¸—à¸±à¸™à¸—à¸µà¸—à¸µà¹ˆà¸”à¸²à¸§à¸™à¹Œà¹‚à¸«à¸¥à¸”à¸ˆà¸²à¸ Host à¹€à¸ªà¸£à¹‡à¸ˆ"},
                        ...
                        {"info_default", "à¸à¸£à¸¸à¸“à¸²à¹€à¸¥à¸·à¸­à¸à¸¡à¹‡à¸­à¸”à¸ˆà¸²à¸à¸£à¸²à¸¢à¸Šà¸·à¹ˆà¸­à¸”à¹‰à¸²à¸™à¸‹à¹‰à¸²à¸¢à¹€à¸žà¸·à¹ˆà¸­à¸”à¸¹à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”"},
                        {"btn_install_mod", "à¸•à¸´à¸”à¸•à¸±à¹‰à¸‡à¸¡à¹‡à¸­à¸”à¸™à¸µà¹‰"},
                        {"btn_uninstall_mod", "à¸–à¸­à¸”à¸–à¸­à¸™à¸¡à¹‡à¸­à¸”à¸™à¸µà¹‰"},
                        {"btn_delete_mod", "à¸¥à¸šà¸¡à¹‡à¸­à¸”à¸™à¸µà¹‰"},
                        
                        {"lbl_users", "ðŸ‘¥ à¸œà¸¹à¹‰à¹ƒà¸Šà¹‰à¸‡à¸²à¸™à¹ƒà¸™à¸«à¹‰à¸­à¸‡: -"},
                        {"lbl_upload", "à¸­à¸±à¸›à¹‚à¸«à¸¥à¸”"},
                        {"lbl_download", "à¸”à¸²à¸§à¸™à¹Œà¹‚à¸«à¸¥à¸”"},
                        {"lbl_install", "à¸•à¸´à¸”à¸•à¸±à¹‰à¸‡"},
                        {"btn_disconnect", "à¸¢à¸à¹€à¸¥à¸´à¸à¸à¸²à¸£à¹€à¸Šà¸·à¹ˆà¸­à¸¡à¸•à¹ˆà¸­"},
                        {"btn_clear_log", "à¸¥à¹‰à¸²à¸‡ Log"},

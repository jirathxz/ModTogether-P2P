...
namespace ModTogether.Plugins.MHW
{
    public static class App
    {
        ...
        public static ModTogether.Plugins.MHW.Services.ModInstaller? Installer { get; set; }
    ...
    public class MhwModPlugin : IModPlugin
    {
        ...
        public bool IsValidGameDirectory(string gameDirectory)
        {
            ...
            return System.IO.File.Exists(System.IO.Path.Combine(gameDirectory, "MonsterHunterWorld.exe"));
        }
    }
}
